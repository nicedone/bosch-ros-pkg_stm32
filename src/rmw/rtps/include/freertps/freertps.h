...
#define FREERTPS_INFO(...) \
  do { printf("freertps INFO : "); os_printf(__VA_ARGS__); } while (0)
#define FREERTPS_ERROR(...) \
  do { printf("freertps ERROR: "); os_printf(__VA_ARGS__); } while (0)
#define FREERTPS_FATAL(...) \
  do { printf("freertps FATAL: "); os_printf(__VA_ARGS__); } while (0)
