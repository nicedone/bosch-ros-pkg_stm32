...
public:
    ...
    DataReader* addDataReader(const char* callerID, const char* topic, const char* md5sum, const char* msgType);
    DataWriter* addDataWriter(const char* callerID, const char* topic, const char* msgType);
private:
